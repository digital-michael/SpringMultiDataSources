...
/**
 * Provides data source definition for log using default application.properties
 *
...
public class LogConfig extends AbstractDataSourceConfig {

    //SET THIS:
    static final private String NAME = "log";
...
//    static final private String JPA_BEAN = "jpa" + NAME;
    ...
    public LogConfig() {
        super();
        System.out.println("reading from: default(log)" ); // + DATASOURCE_PREFIX);
    }
...
//    @ConfigurationProperties(prefix = DATASOURCE_PREFIX)
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
            @Qualifier(ENTITY_MANAGER_FACTORY_BUILDER_BEAN_NAME) EntityManagerFactoryBuilder builder,
            /*@Qualifier(DATA_SOURCE_BEAN_NAME)*/ DataSource dataSource) {
        return builder
                .dataSource(dataSource)
//                .packages(PACKAGES) // Entities
